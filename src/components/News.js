...
export class News extends Component {
  ...
  OnPreClick = async()=>{
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=4db44da849824945b692d2d857c60f4e&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
  ...
  async componentDidMount(){
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=4db44da849824945b692d2d857c60f4e&pageSize=${this.props.pageSize}`;
    this.setState({loading:true})
    let data = await fetch(url);
    let parsedData = await data.json();
